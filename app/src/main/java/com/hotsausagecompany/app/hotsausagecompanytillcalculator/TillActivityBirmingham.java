...
public class TillActivityBirmingham extends Activity implements OnClickListener {
    ...
    TextView chickenhalfcount;
    TextView chickenfullcount;
    TextView chickenccount;
    TextView chickenchalfcount;
    TextView chickencfullcount;
    ...
    int counter_chicken = 0;
    int counter_chickenhalf = 0;
    int counter_chickenfull = 0;
    int counter_chickenc = 0;
    int counter_chickenchalf = 0;
    int counter_chickencfull = 0;
    ...
    int counter_chickenstaff = 0;
    int counter_chickencstaff = 0;
    ...
    String getDrinkfull;
    String getChicken;
    String getChickenhalf;
    String getChickenfull;
    String getChickenc;
    String getChickenchalf;
    String getChickencfull;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_till_birmingham);
        ...
        chickenc = (Button) findViewById(R.id.chickenc);
        ...
        chickencount = (TextView) findViewById(R.id.chickencount);
        chickenhalfcount = (TextView) findViewById(R.id.chickenhalfcount);
        chickenfullcount = (TextView) findViewById(R.id.chickenfullcount);
        chickenccount = (TextView) findViewById(R.id.chickenccount);
        chickenchalfcount = (TextView) findViewById(R.id.chickenchalfcount);
        chickencfullcount = (TextView) findViewById(R.id.chickencfullcount);
        ...
        chickenstaffcount = (TextView) findViewById(R.id.chickenstaffcount);
        chickencstaffcount = (TextView) findViewById(R.id.chickencstaffcount);
        ...
        chickenwastecount = (TextView) findViewById(R.id.chickenwastecount);
        ...
        chickenc.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.regularc:
                ...
                else if (regularcText == "Lar Bun Waste"){
                    number +=0;
            ...
            case R.id.chicken:
                ...
                if (chickenText == "Chick Half") {
                    if (counter_chicken < 1){
                        number +=165;
                    }
                    else {
                        number -=165;
                        counter_chicken--;
                        chickencount.setText("" + counter_chicken);
                    }
                    counter_chickenhalf++;
                    chickenhalfcount.setText("" + counter_chickenhalf);
                    regular.setText("Regular");
                    regularc.setText("Reg + C");
                    large.setText("Large");
                    largec.setText("Lar + C");
                ...
                else if (chickenText == "Chick Full"){
                    if (counter_chicken < 1){
                        number +=0;
                    }
                    else {
                    ...
                    counter_chickenfull++;
                    chickenfullcount.setText("" + counter_chickenfull);
                    regular.setText("Regular");
                    regularc.setText("Reg + C");
                    large.setText("Large");
                    largec.setText("Lar + C");
                ...
                else if (chickenText == "Chicken") {
                    number += 330;
                    counter_chicken++;
                    chickencount.setText("" + counter_chicken);
                }
                else if (chickenText == "Chick Waste"){
                    number +=0;
                    counter_chickenwaste++;
                    chickenwastecount.setText("" + counter_chickenwaste);
                }
                else if (chickenText == "Chick Staff"){
                    number +=0;
                    counter_chickenstaff++;
                    chickenstaffcount.setText("" + counter_chickenstaff);
                }
                break;
            case R.id.drink:
                ...
                else if (drinkText == "Sml Bun Waste"){
                    number +=0;
            ...
            case R.id.staff:
                ...
                chicken.setText("Chick Staff");
                chickenc.setText("Chick C Staff");
                drink.setText("Drink Staff");
                break;

            case R.id.chickenc:
                String chickencText = chickenc.getText().toString();
                if (chickencText == "Chick C Half") {
                    if (counter_chickenc < 1){
                        number +=185;
                    }
                    else {
                        number -=185;
                        counter_chickenc--;
                        chickenccount.setText("" + counter_chickenc);
                    }
                    counter_chickenchalf++;
                    chickenchalfcount.setText("" + counter_chickenchalf);
                    regular.setText("Regular");
                    regularc.setText("Reg + C");
                    large.setText("Large");
                    largec.setText("Lar + C");
                ...
                else if (chickencText == "Chick C Full"){
                    if (counter_chickenc < 1){
                        number +=0;
                    }
                    else {
                    ...
                    counter_chickencfull++;
                    chickencfullcount.setText("" + counter_chickencfull);
                    regular.setText("Regular");
                    regularc.setText("Reg + C");
                    large.setText("Large");
                    largec.setText("Lar + C");
                ...
                else if (chickencText == "Chick + C") {
                    number += 370;
                    counter_chickenc++;
                    chickenccount.setText("" + counter_chickenc);
                }
                else if (chickencText == "Chick C Staff") {
                    number += 0;
                    counter_chickencstaff++;
                    chickencstaffcount.setText("" + counter_chickencstaff);
                }
                else if (chickencText == ""){
                }
            ...
            case R.id.saver:
                ...
                chickenText = chicken.getText().toString();
                if (chickenText == "Chicken") {
                    chicken.setText("Chick Half");
                }
                else if (chickenText == "Chick Half"){
                    chicken.setText("Chick Full");
                }
                else if (chickenText == "Chick Full") {
                    chicken.setText("Chicken");
                }

                chickencText = chickenc.getText().toString();
                if (chickencText == "Chick + C") {
                    chickenc.setText("Chick C Half");
                }
                else if (chickencText == "Chick C Half"){
                    chickenc.setText("Chick C Full");
                }
                else if (chickencText == "Chick C Full") {
                    chickenc.setText("Chick + C");
                }
            ...
            case R.id.waste:
                ...
                regularc.setText("Lar Bun Waste");
                ...
                specialc.setText("");
                chicken.setText("Chick Waste");
                chickenc.setText("");
                drink.setText("Sml Bun Waste");
                break;
            case R.id.cancel:
                number=0;
                counter_regular=0;
                ...
                counter_chicken=0;
                chickencount.setText("");
                counter_chickenhalf=0;
                chickenhalfcount.setText("");
                counter_chickenfull=0;
                chickenfullcount.setText("");
                counter_chickenc=0;
                chickenccount.setText("");
                counter_chickenchalf=0;
                chickenchalfcount.setText("");
                counter_chickencfull=0;
                chickencfullcount.setText("");
                ...
                counter_chickenstaff=0;
                chickenstaffcount.setText("");
                counter_chickencstaff=0;
                chickencstaffcount.setText("");
                ...
                counter_chickenwaste=0;
                chickenwastecount.setText("");
            ...
            case R.id.send:
                ...
                getChicken = chickencount.getText().toString();
                getChickenhalf = chickenhalfcount.getText().toString();
                getChickenfull = chickenfullcount.getText().toString();
                getChickenc = chickenccount.getText().toString();
                getChickenchalf = chickenchalfcount.getText().toString();
                getChickencfull = chickencfullcount.getText().toString();
                ...
                getChickenstaff = chickenstaffcount.getText().toString();
                getChickencstaff = chickencstaffcount.getText().toString();
                ...
                try{
                    ...
                    bw.write("INSERT INTO SalesData (datecol,timecol,site,regular,regular_and_cheese,large,large_and_cheese,footlong,footlong_and_cheese,special,special_and_cheese,drink,chicken,chicken_and_cheese,half_regular,half_regular_and_cheese,half_large,half_large_and_cheese,half_footlong,half_footlong_and_cheese,half_special,half_special_and_cheese,half_drink,half_chicken,half_chicken_and_cheese,full_regular,full_regular_and_cheese,full_large,full_large_and_cheese,full_footlong,full_footlong_and_cheese,full_special,full_special_and_cheese,full_drink,full_chicken,full_chicken_and_cheese,staff_regular,staff_regular_and_cheese,staff_large,staff_large_and_cheese,staff_footlong,staff_footlong_and_cheese,staff_special,staff_special_and_cheese,staff_drink,staff_chicken,staff_chicken_and_cheese,regular_waste,large_waste,footlong_waste,special_waste,chicken_waste,small_bun_waste,large_bun_waste,total) VALUES ('"+timestamp+"', '"+time+"', '"+sitename+"', '"+getRegular+"', '"+getRegularc+"', '"+getLarge+"', '"+getLargec+"', '"+getFootlong+"', '"+getFootlongc+"', '"+getSpecial+"', '"+getSpecialC+"', '"+getDrink+"', '"+getChicken+"', '"+getChickenc+"', '"+getRegularhalf+"', '"+getRegularchalf+"', '"+getLargehalf+"', '"+getLargechalf+"', '"+getFootlonghalf+"', '"+getFootlongchalf+"', '"+getSpecialhalf+"', '"+getSpecialchalf+"', '"+getDrinkhalf+"', '"+getChickenhalf+"', '"+getChickenchalf+"', '"+getRegularfull+"', '"+getRegularcfull+"', '"+getLargefull+"', '"+getLargecfull+"', '"+getFootlongfull+"', '"+getFootlongcfull+"', '"+getSpecialfull+"', '"+getSpecialcfull+"', '"+getDrinkfull+"', '"+getChickenfull+"', '"+getChickencfull+"', '"+getRegularstaff+"', '"+getRegularcstaff+"', '"+getLargestaff+"', '"+getLargecstaff+"', '"+getFootlongstaff+"', '"+getFootlongcstaff+"', '"+getSpecialstaff+"', '"+getSpecialCstaff+"', '"+getDrinkstaff+"', '"+getChickenstaff+"', '"+getChickencstaff+"', '"+getRegularwaste+"', '"+getLargewaste+"', '"+getFootlongwaste+"', '"+getSpecialwaste+"', '"+getChickenwaste+"', '"+getSmallbunwaste+"', '"+getLargebunwaste+"', '"+number/100+"'); ");
                    bw.newLine();
                    bw.flush();
                    bw.close();
